    ...
    <body>
        ...
        <section class="bloc1">
            <div id="lookup">
				...
				<h2>This day is ${weatherCondition}, you should visit these points of interest :</h2>
			</div>
			
			<P>
				<c:forEach items="${weatherDetail}" var="result">
			   		<P><a class="linksearch" id="left-align" href="/springrestclient/nearby/result/details/${result.placeId}" target="_blank"><c:out value="${result.name}"/></a></P>
				</c:forEach>
				<br>
			</P>
			</section>
