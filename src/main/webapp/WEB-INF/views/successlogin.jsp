	...
	<section class="bloc1">
		...
		<div class="register_window">
			<p>Successfully Login</p>
				<br>ID: ${id}<br>
				<br>Your recent search: <br>
				<br> 
				
				<c:forEach items="${recentSearch}" var="place">
	   				<P><a class="linksearch" class="left-align" href="/springrestclient/nearby/auto/choix/${place}"><c:out value="${place}"/></a></P>
				</c:forEach>
				<br> Click <a href="application">here</a> to go to the Application Page. 
				<br>
		</div>
		<br>
		<br>
