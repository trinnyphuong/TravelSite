    ...
    <body>
        ...
        <section class="bloc1">
            <div id="lookup">
				...
				<h2>${resultDetails.name}</h2>
			
				<div id="left-align">
					Address : ${resultDetails.formattedAddress}<br>
					Phone Number : ${resultDetails.formattedPhoneNumber}<br>
					WebSite : ${resultDetails.website}<br>
					Open now : ${resultDetails.openingHours.openNow}<br><br><br><br>
