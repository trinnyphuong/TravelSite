	...
	<section class="bloc1">
		...
		<div class="register_window">
			...
			<form action="registerissue" method="POST">
				<br>ID<br> <input class="user_input" autofocus="autofocus"
					name="loginId"> <br>
				<br>PASSWORD<br> <input type="password" class="user_input"
					autofocus="autofocus" name="pwd1"> <br>
	  			<br>CONFIRM PASSWORD<br> <input type="password" class="user_input"
					autofocus="autofocus" name="pwd2"> <br> 
				<br>
