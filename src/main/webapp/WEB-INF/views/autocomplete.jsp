...
<html>
    ...
    <body>
        ...
        <section class="bloc1">
			...
			<p>
				<h2 class="left-align">Choose one place</h2>
				<c:forEach items="${autocomplete}" var="place">
	   				<P><a class="linksearch" class="left-align" href="/springrestclient/nearby/auto/choix/${place.description}"><c:out value="${place.description}"/></a></P>
				</c:forEach>
			</p>
